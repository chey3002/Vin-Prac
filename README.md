...
2) npm install
3) npm run dev
4) Crear la base de datos "vin_prac"
5) Importar la base de datos con el archivo vin_prac_SQL.sql
...
## Avances:
Los avances fueron registrados en el [archivo excel](HORAS%20PR%C3%81CTICAS%20Carlos%20Valladarez.xlsx) con el formato correspondiente
### Semana 1
